...
const CALENDAR = [
  ...
  // 빈 구간을 메우는 계기 (2026년 기준 35·38·19일 공백에 들어간다).
  // 법정기념일 164개를 다 넣지 않은 이유: 무역의 날·원자력 안전 및 진흥의 날처럼
  // 초등 교실에서 쓸 자리가 없는 것이 대부분이고, 달력이 길어져 정작 쓰는 계기일을
  // 찾기 어려워진다. 여기서는 수업일에 걸리고 교과 연계가 되는 것만 골랐다.
  { md: '02-28', name: '2·28 민주운동 기념일',    topic: '민주시민' },
  { md: '03-03', name: '납세자의 날',            topic: '경제' },
  { md: '03-15', name: '3·15 의거 기념일',       topic: '민주시민' },
  { md: '03-22', name: '물의 날',                topic: '환경생태' },
  { md: '05-01', name: '근로자의 날',            topic: '인권' },
  { md: '05-19', name: '발명의 날',              topic: '과학·탐구' },
  { md: '06-01', name: '의병의 날',              topic: '역사' },
  { md: '06-10', name: '6·10 민주항쟁 기념일',    topic: '민주시민' },
  { md: '11-19', name: '아동학대예방의 날',       topic: '인권' },
  { md: '12-03', name: '소비자의 날',            topic: '경제' },
  { md: '12-10', name: '인권의 날',              topic: '인권' },
];
