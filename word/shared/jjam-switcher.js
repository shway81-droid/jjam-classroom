/* ===================================================================
   ...
   ===================================================================
   짬짬이 게임·퀴즈·영상·이야기·낱말·1분 수업은 저장소가 여섯으로 갈라져 있지만
...
(function () {
  ...
  //
  // 헤더에 거는 것은 **완성된 여섯**뿐이다 — 게임·퀴즈·영상·이야기·낱말·1분 수업.
  ...
  var SITES = [
    ...
    { key: '1min',  label: '짬짬이1분수업', go: '짬짬이 1분 수업으로 가기',
  ...
  var ART = {
    ...
    '1min':
      ...
      '<path d="M39 50 L39 68 L54 59 Z" fill="#FFFFFF"/>' + BADGE,
