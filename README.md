...
- **이야기 25편, 5개 유형** — 🔮 다음 이야기(상상) / 🕵️ 왜 그랬을까(추리) / 💗 마음 읽기(감정) / ⚖️ 선택 이야기(가치판단) / ✏️ 한 문장 이어쓰기(확장)
...
- **개인·짝·전체 활동 방식** — 혼자 생각 모드에서는 대화 단계 시간을 생각 시간에 합산
...
```json
{
  "id": "next-005",
  "title": "제목",
  "type": "next-story | why | mind | choice | continue",
