...
(function () {
  ...
  var PROBLEM_POOL = [
    ...
    { target: 2, p1: [17, 9, 10, 1], p2: [3, 11, 14, 4] },
    { target: 2, p1: [11, 6, 4, 2], p2: [9, 20, 6, 2] },
    { target: 2, p1: [16, 13, 8, 10], p2: [8, 6, 1, 18] },
    { target: 3, p1: [4, 10, 6, 18], p2: [11, 13, 7, 10] },
    { target: 3, p1: [1, 8, 11, 14], p2: [5, 10, 19, 4] },
    { target: 3, p1: [8, 13, 1, 12], p2: [14, 13, 16, 11] },
    { target: 3, p1: [16, 10, 1, 17], p2: [10, 20, 12, 2] },
    { target: 3, p1: [18, 7, 15, 8], p2: [12, 7, 8, 5] },
    { target: 3, p1: [12, 2, 18, 6], p2: [1, 9, 10, 20] },
    { target: 3, p1: [8, 5, 18, 11], p2: [8, 2, 12, 15] },
    { target: 4, p1: [14, 11, 6, 8], p2: [15, 20, 5, 11] },
    { target: 4, p1: [12, 4, 3, 13], p2: [17, 8, 10, 5] },
    { target: 4, p1: [8, 2, 9, 7], p2: [13, 14, 6, 10] },
    { target: 4, p1: [14, 17, 15, 13], p2: [18, 3, 20, 13] },
    { target: 5, p1: [14, 6, 1, 3], p2: [15, 10, 1, 6] },
    { target: 5, p1: [15, 3, 13, 7], p2: [17, 19, 8, 18] },
    { target: 5, p1: [12, 13, 3, 14], p2: [18, 17, 16, 13] },
    { target: 6, p1: [6, 18, 8, 4], p2: [12, 7, 11, 13] },
    { target: 6, p1: [10, 15, 9, 14], p2: [18, 9, 5, 20] },
    { target: 6, p1: [13, 7, 2, 11], p2: [1, 15, 12, 16] },
    { target: 6, p1: [3, 13, 11, 7], p2: [8, 19, 17, 9] },
    { target: 7, p1: [8, 18, 14, 6], p2: [3, 11, 7, 15] },
    { target: 7, p1: [5, 17, 11, 15], p2: [1, 12, 7, 18] },
    { target: 7, p1: [10, 14, 8, 4], p2: [18, 8, 3, 13] },
    { target: 7, p1: [3, 12, 13, 4], p2: [4, 20, 9, 6] },
    { target: 8, p1: [5, 9, 6, 2], p2: [11, 19, 2, 1] },
    { target: 8, p1: [6, 2, 14, 18], p2: [10, 17, 1, 18] },
    { target: 8, p1: [4, 16, 17, 2], p2: [9, 20, 10, 15] },
    { target: 8, p1: [3, 12, 9, 18], p2: [11, 19, 7, 1] },
    { target: 9, p1: [9, 5, 10, 14], p2: [10, 11, 17, 14] },
    { target: 9, p1: [14, 18, 3, 2], p2: [2, 11, 20, 8] }
  ];
  ...
  function checkAnswer() {
    ...
    if (ok) {
      ...
      var big = Math.max(p1Selected.val, p2Selected.val);
      var small = Math.min(p1Selected.val, p2Selected.val);
      showBanner('성공! ' + big + ' − ' + small + ' = ' + problem.target, 'ok');
      sounds.play('correct');
    } else {
      p1Card.classList.add('wrong');
      p2Card.classList.add('wrong');
      showBanner('아쉬워요! 두 수의 차 = ' + diff + ' (목표 ' + problem.target + ')', 'ng');
      sounds.play('wrong');
    }
