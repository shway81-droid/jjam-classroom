/* games/lonely-find/game.js — 외톨이 찾기 (짝 없는 그림 찾기 2~4인) */
...
// 라운드별 난이도
// phase 1: 3종(짝 2쌍 + 외톨이 1), 6초
// phase 2: 4종(짝 3쌍 + 외톨이 1), 5초 — 더 빽빽
const MS_ROUND_PLAN = [
  { phase: 1, timeLimit: 6 },
  { phase: 1, timeLimit: 6 },
  { phase: 1, timeLimit: 5 },
...
(function() {
  ...
  if (el) {
    el.innerHTML = '<svg viewBox="0 0 220 110" xmlns="http://www.w3.org/2000/svg">' +
      ...
      '<text x="40" y="40" font-size="22">🍎</text>' +
      '<text x="78" y="40" font-size="22">🍎</text>' +
      '<text x="124" y="40" font-size="22">🍌</text>' +
      '<text x="162" y="40" font-size="22">🍌</text>' +
      '<circle cx="110" cy="70" r="17" fill="#FFE082" stroke="#7E57C2" stroke-width="3"/>' +
      '<text x="110" y="78" text-anchor="middle" font-size="20">🍇</text>' +
      '<text x="110" y="100" text-anchor="middle" font-size="13" font-weight="900" fill="#7E57C2">🍇 외톨이!</text>' +
      '</svg>';
  }
})();
...
function msHandleItemTimeout() {
  ...
  msProblemStatus.textContent = '⏰ 정답: ' + currentItem.answer + ' (짝 없는 외톨이)';
...
function msShowResult() {
  ...
  msRoundLog.forEach(function(log) {
    ...
    var phaseLabel = ['', '쉬움(3종)', '도전(4종)'][plan.phase];
